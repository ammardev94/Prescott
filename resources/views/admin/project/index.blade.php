                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                @if($project->thumbnail_img)
                                    <span class="avatar avatar-xxxl me-2">
                                        <img src="{{ asset('storage/'.$project->thumbnail_img) }}" alt="{{ $project->title }}">
                                    </span>
                                @endif
                            </td>
                            <td>{{ $project->title }}</td>
                            ...
                            <td class="text-center">
                                <div class='btn-group'>
                                    <a href="{{ route('admin.project.edit', $project->id) }}" class="btn btn-default btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form class="delete-project-form" action="{{ route('admin.project.destroy', $project->id) }}" method="POST">
                                        @method('DELETE')
                                        @csrf
    ...
    $(document).ready(function () {
        $(".delete-project-form").on("submit", function (e) {
            ...
            Swal.fire({
                ...
                icon: "warning",
                html: `<p>Do you really want to delete this project?</p>`,
