...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form action="{{ route('admin.amenity.store') }}" method="POST" id="addAmenity" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" id="title" placeholder="Enter amenity title" value="{{ old('title') }}">
                            </div>
                        </div>
